...
@objc(CDVBMSPush) class CDVBMSPush : CDVPlugin {
    ...
    func didReceiveRemoteNotification(notification: NSDictionary?) {
        //print("Comes here in swift version 3 didReceiveRemoteNotification fn ")
        //dump(notification)
        ...
        notif["isBackground"] = true as AnyObject?
     ...
     */
    func didReceiveRemoteNotification(notification: NSDictionary?) {
        print("Comes here in swift version 2 didReceiveRemoteNotification fn ")
        var notif: [String : AnyObject] = [:]
