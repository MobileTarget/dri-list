(function(angular, DomenowApp, undefined){
  ...
  SemiRealTimeChangesMethod.$inject = ['LOCAL_DB', '$http', 'utilityService', 'SocketBroadCastEvents', '$localStorage', 'myService', "async"];
  
  function SemiRealTimeChangesMethod(LOCAL_DB, $http, utilityService, SocketBroadCastEvents, $localStorage, myService, async){
    var self = this ;
